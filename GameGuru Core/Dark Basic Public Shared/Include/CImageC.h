...
struct tagImgData
{
	...
	LPGGTEXTUREREF			pObsolete;//lpTextureView;				// DX11 resource view
};
#endif
...
DARKSDK void				CreateReplaceImage				( int iID, int iTexSize, void* pTex, void* pView );
...
DARKSDK void*				PreloadThreadSafeImage		( LPSTR szFilename , int iMipMaps = -1 );
